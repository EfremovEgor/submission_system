<script>
	import RussianSubmissionForm from './../../../../lib/components/forms/russianSubmissionForm/russianSubmissionForm.svelte';
	import EnglishSubmitForm from './../../../../lib/components/forms/englishSubmissionForm/englishSubmitForm.svelte';
...
<div class="container">
	...
	{:else}
		...
		{/if}
		{#if is_ru == true}
			<RussianSubmissionForm bind:isBusy bind:sentEmail {userDetails} {conferenceData} />
		{:else if is_ru == false}
			<EnglishSubmitForm bind:isBusy bind:sentEmail {userDetails} {conferenceData} />
		{/if}
	{/if}
</div>
